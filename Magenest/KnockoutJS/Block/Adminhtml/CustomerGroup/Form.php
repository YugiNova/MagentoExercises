 ...
 */
namespace Magenest\KnockoutJS\Block\Adminhtml\CustomerGroup;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareLayout()
    {
        ...
        if ($this->_backendSession->getCustomerGroupData()) {
            ...
            $popups = $connection->fetchAll('select * from magenest_popup where customer_group_id = ?',[$customerGroup->getId()]);
            $form->addValues(
                [
